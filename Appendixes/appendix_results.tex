...
\captionof{figure}{Single intersection: average combined delay per epoch.} \label{fig:timeLoss_j1}
\end{minipage}
...
\centering
  ...
  \captionof{figure}{Single intersection: average combined throughput per epoch.} \label{fig:throughput_j1}
\end{minipage}
...
\centering
  ...
  \captionof{figure}{Single intersection: average car throughput per epoch.} \label{fig:throughput_cars_j1}
\end{minipage}%
...
\centering
  ...
  \captionof{figure}{Single intersection: average bicycle throughput per epoch.} \label{fig:throughput_bikes_j1}
\end{minipage}
...
\centering
  ...
  \captionof{figure}{Single intersection: average pedestrian throughput per epoch.} \label{fig:throughput_pedestrians_j1}
\end{minipage}%
...
\centering
  ...
  \captionof{figure}{Single intersection: accumulated waiting time, for cars, per epoch.} \label{fig:total_wait_cars_j1}
\end{minipage}
...
\centering
  ...
  \captionof{figure}{Single intersection: accumulated waiting time, for bicycles, per epoch.} \label{fig:total_wait_bikes_j1}
\end{minipage}%
...
\centering
  ...
  \captionof{figure}{Single intersection: accumulated waiting time, for pedestrians, per epoch.} \label{fig:total_wait_pedestrians_j1}
\end{minipage}
...
\centering
  ...
  \captionof{figure}{Single intersection: fraction of waiting time due to bicycles, per epoch.} \label{fig:frac_wait_bikes_j1}
\end{minipage}%
...
\centering
  ...
  \captionof{figure}{Single intersection: fraction of waiting time due to pedestrians, per epoch.} \label{fig:frac_wait_pedestrians_j1}
\end{minipage}
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: average combined delay per epoch.} \label{fig:timeLoss_c2}
\end{minipage}%
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: average combined throughput per epoch.} \label{fig:throughput_c2}
\end{minipage}
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: average car throughput per epoch.} \label{fig:throughput_cars_c2}
\end{minipage}%
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: average bicycle throughput per epoch.} \label{fig:throughput_bikes_c2}
\end{minipage}
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: average pedestrian throughput per epoch.} \label{fig:throughput_pedestrians_c2}
\end{minipage}%
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: accumulated waiting time, for cars, per epoch.} \label{fig:total_wait_cars_c2}
\end{minipage}
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: accumulated waiting time, for bicycles, per epoch.} \label{fig:total_wait_bikes_c2}
\end{minipage}%
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: accumulated waiting time, for pedestrians, per epoch.} \label{fig:total_wait_pedestrians_c2}
\end{minipage}
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: fraction of waiting time due to bicycles, per epoch.} \label{fig:frac_wait_bikes_c2}
\end{minipage}%
...
\makebox[\linewidth]{%        to center the image
  ...
  \captionof{figure}{Corridor: fraction of waiting time due to pedestrians, per epoch.} \label{fig:frac_wait_pedestrians_c2}
\end{minipage}