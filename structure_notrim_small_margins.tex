...
\usepackage{cite} % numeric citation sorting/compression
\providecommand{\bibnumfmt}[1]{#1.}
% Compatibility shims for documents that used natbib commands
\providecommand{\citet}[1]{\cite{#1}}
\providecommand{\citep}[1]{\cite{#1}}
\usepackage{graphicx} % Required to include images
\usepackage{pdfpages} % Required to include PDF pages
...
%\usepackage{kpfonts} % kepler fonts, las viejas de la tesis
\usepackage[lining]{ibarra} % remove option 'lining' to get oldstyle figures as default
\usepackage[scaled]{ulgothic} % para el código
...
\usepackage[acronym,automake]{glossaries} % glosario + acrónimos
\expandafter\def\csname AC@undonewlabel\endcsname#1{}
\newglossary{notation}{not}{ntn}{List of Notations} % Define a new glossary type for notations
...
\makeatletter
\renewcommand{\fnum@table}{\textsc{\tablename~\thetable}} % Make the "Table 1.1" text in small caps
\makeatother
...
% Remove bold from section and subsection titles
...
%----------------------------------------------------------------------------------------
%	HYPERREF LINK COLORS (must be at the end after all packages)
%----------------------------------------------------------------------------------------

\definecolor{darkblue}{rgb}{0,0,0.5}
\hypersetup{colorlinks=true, breaklinks, linkcolor=darkblue, citecolor=darkblue, filecolor=darkblue, urlcolor=darkblue, anchorcolor=darkblue}
