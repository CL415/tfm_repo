...
%\input{structure_book_08reduction_centered.tex} % Include the file containing the code defining the structure and style of the document, use for no trims and centered content
